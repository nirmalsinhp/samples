...
int main()
{
    ...
    cout << "Insertion " << d11.count() <<  " MicoSeconds(s)" << endl;
    cout << boolalpha << is_sorted(v.begin(), v.end()) << endl;;
    ...
    // cout << boolalpha << is_sorted(v.begin(), v.end()) << endl;;
    // cout << "Selection "  << d2.count() << " MicoSeconds(s)" << endl;
    ...
    cout << boolalpha << is_sorted(v.begin(), v.end()) << endl;;
    cout << "merge "  << d3.count() << " MicoSeconds(s)" << endl;
    ...
    cout << boolalpha << is_sorted(v.begin(), v.end()) << endl;;
    cout << "Quick "  << d4.count() << " MicoSeconds(s)" << endl;
    ...
    cout << "Heap "  << d5.count() << " MicoSeconds(s)" << endl;
